...
public class VoteRules {
    ...
    private static final WeightedList<Reference<Vote>> POOL_BUILDER = new WeightedList<>();
    ...
    public static class TranslatableIntRule extends NumberVoteRule.IntegerRule {
        private final String translationKey;
        public TranslatableIntRule(int defaultValue, IntProvider provider, String translationKey) {
            super(defaultValue, provider);
            this.translationKey = translationKey;
        }
        @Override
        protected Text getOptionDescription(Integer val) {
            return Text.translatable(translationKey, val);
        }
    }
    
    public static class TranslatableEnumRule<T> extends EnumVoteRule<T> {
    	private final String key;
        public TranslatableEnumRule(T[] values, T defaultValue, Codec<T> codec, String key) {
            super(values, defaultValue, codec);
            
            this.key = key;
        }
		@Override
		protected Text getOptionDescription(T value) {
			return Text.translatable(key, value);
		}
    }

    public static class TranslatableFloatRule extends NumberVoteRule.FloatRule {
        private final String translationKey;
        public TranslatableFloatRule(float defaultValue, ClampedNormalFloatProvider provider, String translationKey) {
            super(defaultValue, provider);
            this.translationKey = translationKey;
        }
        @Override
        protected Text getOptionDescription(Float val) {
            return Text.translatable(translationKey, Math.round(val * 100.0F));
        }
    }

    public static class TranslatableOptionCountRule extends VoteOptionCountRule {
        private final String translationKey;
        public TranslatableOptionCountRule(UniformIntProvider p1, UniformIntProvider p2, UniformIntProvider p3, String key) {
            super(p1, p2, p3);
            this.translationKey = key;
        }
        @Override
        protected Text getOptionDescription(UniformIntProvider provider) {
            return Text.translatable(translationKey, provider.toString());
        }
    }
    ...
    public static final TranslatableIntRule MAX_RESULTS = register("vote_max_results", 1000, new TranslatableIntRule(1, UniformIntProvider.create(1, 5), "rule.vote_max_results"));
    public static final TranslatableIntRule CHANCE_PER_TICK = register("new_vote_chance_per_tick", 500, new TranslatableIntRule(200, UniformIntProvider.create(1, 2000), "rule.new_vote_chance_per_tick"));
    public static final TranslatableOptionCountRule APPROVE_OPTION_COUNT = register("new_vote_approve_option_count", 500, new TranslatableOptionCountRule(UniformIntProvider.create(1, 5), UniformIntProvider.create(0, 4), UniformIntProvider.create(2, 4), "rule.new_vote_approve_option_count"));
    public static final TranslatableOptionCountRule REPEAL_OPTION_COUNT = register("new_vote_repeal_option_count", 500, new TranslatableOptionCountRule(UniformIntProvider.create(1, 5), UniformIntProvider.create(0, 4), UniformIntProvider.create(2, 4), "rule.new_vote_repeal_option_count"));
    public static final TranslatableOptionCountRule VOTE_DURATION = register("new_vote_duration_minutes", 1000, new TranslatableOptionCountRule(UniformIntProvider.create(1, 20), UniformIntProvider.create(0, 10), UniformIntProvider.create(8, 16), "rule.new_vote_duration_minutes"));
    public static final TranslatableIntRule EXTRA_EFFECT_CHANCE = register("new_vote_extra_effect_chance", 1000, new TranslatableIntRule(30, UniformIntProvider.create(0, 80), "rule.new_vote_extra_effect_chance"));
    public static final TranslatableIntRule EXTRA_EFFECT_MAX_COUNT = register("new_vote_extra_effect_max_count", 1000, new TranslatableIntRule(1, UniformIntProvider.create(0, 5), "rule.new_vote_extra_effect_max_count"));
    public static final TranslatableIntRule REPEAL_VOTE_CHANCE = register("new_vote_repeal_vote_chance", 500, new TranslatableIntRule(50, UniformIntProvider.create(20, 80), "rule.new_vote_repeal_vote_chance"));
    ...
    public static final TranslatableIntRule MAX_APPROVE_COUNT = register("new_vote_max_approve_vote_count", 500, new TranslatableIntRule(5, UniformIntProvider.create(1, 10), "rule.new_vote_max_approve_vote_count"));
    public static final TranslatableIntRule MAX_REPEAL_COUNT = register("new_vote_max_repeal_vote_count", 500, new TranslatableIntRule(2, UniformIntProvider.create(1, 10), "rule.new_vote_max_repeal_vote_count"));
    ...
    public static final TranslatableEnumRule<WorldShape> WORLD_SHAPE = register("world_shape", 1000, new TranslatableEnumRule<>(WorldShape.values(), WorldShape.DEFAULT, WorldShape.CODEC, "rule.change_world_shape"));
    ...
    public static final TranslatableIntRule QUORUM_PERCENT = register("quorum_percent", 500, new TranslatableIntRule(0, createClampedPercentProvider(20), "rule.quorum_percent"));
    public static final TranslatableIntRule VOTES_TO_WIN_PERCENT = register("votes_to_win_percent", 125, new TranslatableIntRule(0, createClampedPercentProvider(20), "rule.votes_to_win_percent"));
    ...
    public static final EnumVoteRule<TieBreaker> TIE_STRATEGY = register("tie_strategy", 500, new TranslatableEnumRule<>(TieBreaker.values(), TieBreaker.RANDOM, TieBreaker.CODEC, "rule.tie_strategy."));
    ...
    public static final TranslatableIntRule LAVA_SPREAD_DELAY = register("lava_spread_tick_delay", 500, new TranslatableIntRule(30, UniformIntProvider.create(1, 9), "rule.lava_spread_tick_delay"));
    ...
    public static final EnumVoteRule<WeatherState> RAIN = register("rain", 1000, new TranslatableEnumRule<>(WeatherState.values(), WeatherState.DEFAULT, WeatherState.CODEC, ""));
    public static final EnumVoteRule<WeatherState> THUNDER = register("thunder", 1000, new TranslatableEnumRule<>(WeatherState.values(), WeatherState.DEFAULT, WeatherState.CODEC, ""));
    public static final TranslatableFloatRule GLOBAL_PITCH = register("global_pitch", 1000, new TranslatableFloatRule(1.0F, ClampedNormalFloatProvider.create(1.5F, 0.6F, 0.3F, 3.0F), "rule.global_pitch"));
    public static final TranslatableFloatRule ITEM_USE_SPEED = register("item_use_speed", 1000, new TranslatableFloatRule(1.0F, ClampedNormalFloatProvider.create(1.0F, 0.4F, 0.1F, 8.0F), "rule.item_use_speed"));
    public static final TranslatableFloatRule ATTACK_KNOCKBACK = register("attack_knockback", 1000, new TranslatableFloatRule(1.0F, ClampedNormalFloatProvider.create(1.0F, 0.4F, 0.1F, 8.0F), "rule.attack_knockback"));
    ...
    public static final EnumVoteRule<CapesState> CAPES = register("caep", 1000, new TranslatableEnumRule<>(CapesState.values(), CapesState.NONE, CapesState.CODEC, ""));
    ...
    public static final TranslatableIntRule PUSH_LIMIT = register("push_limit", 1000, new TranslatableIntRule(12, UniformIntProvider.create(0, 23), "rule.push_limit"));
    ...
    public static class NamedEntityVoteRule extends EntityVoteRule implements VoteValue {
		...
		public Text getDescription(VoterAction action) {
			return Text.translatable("rule.ai_attack");
		}
    }
    public static final EntityVoteRule AI_ATTACK = register("ai_attack", 500, new NamedEntityVoteRule());
    ...
    public static final EnumVoteRule<FoodRestriction> FOOD_RESTRICTION = register("food_restriction", 1000, new TranslatableEnumRule<>(FoodRestriction.values(), FoodRestriction.ANY, FoodRestriction.CODEC, "rule.food_restriction."));
    ...
    public static final EnumVoteRule<CollisionStrategy> MINECART_COLLISIONS = register("minecart_collisions", 125, new TranslatableEnumRule<>(CollisionStrategy.values(), CollisionStrategy.NONE, CollisionStrategy.CODEC, "rule.minecart_collisions."));
    public static final EnumVoteRule<CollisionStrategy> BOAT_COLLISIONS = register("boat_collisions", 125, new TranslatableEnumRule<>(CollisionStrategy.values(), CollisionStrategy.NONE, CollisionStrategy.CODEC, "rule.boat_collisions."));
    ...
    public static final TranslatableIntRule DUPE_OCCURRENCE = register("dupe_hack_occurrence_chance", 500, new TranslatableIntRule(0, ClampedNormalIntProvider.of(30.0F, 30.0F, 0, 500), "rule.dupe_hack_occurrence_chance"));
    public static final TranslatableIntRule DUPE_BREAK = register("dupe_hack_break_chance", 500, new TranslatableIntRule(30, ClampedNormalIntProvider.of(30.0F, 30.0F, 0, 100), "rule.dupe_hack_break_chance"));
    public static final TranslatableIntRule SPAWN_EGG_CHANCE = register("spawn_egg_chance", 500, new TranslatableIntRule(0, ClampedNormalIntProvider.of(10.0F, 30.0F, 0, 100), "rule.spawn_egg_chance"));
    ...
    public static final RegistryEntry.Reference<Vote> getRandomRule(Random random) {
        FINAL_POOL.shuffle();
        return FINAL_POOL.stream().findFirst().orElseThrow();
    }
