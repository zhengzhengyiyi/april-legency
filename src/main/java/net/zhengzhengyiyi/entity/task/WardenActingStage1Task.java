 ...
 * Stage 1: sets walk target and stage.
 */
public class WardenActingStage1Task extends MultiTickTask<WardenEntity> {

    public WardenActingStage1Task() {
        super(Map.of(), 40, 80);
    }
    ...
    protected void finishRunning(ServerWorld world, WardenEntity entity, long time) {
        entity.getBrain().remember(MemoryModuleType.WALK_TARGET,
            new net.minecraft.entity.ai.brain.WalkTarget(entity.getBlockPos(), 0.5f, 1));
    }

    /** method_69308 - Checks stage */
    private static boolean method_69308(WardenEntity entity) {
        return entity.getAnger() < 40;
    }
}
